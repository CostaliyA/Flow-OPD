...
def get_config():
    ...
    # - "none": raw KL value (negative as advantage)
    # - "per_sample": normalize KL per sample across all timesteps
    ...
    # KL reward scale (applied as kl_scale * kl_reward as advantage)
    train.kl_scale = 0.0
    train.ema = False
